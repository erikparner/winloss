...
Inference for win-loss parameters using censored event data. The event data can in general be single event. However, we allow the last event to be recurrent events, in which case the number of recurrent event is compared.
